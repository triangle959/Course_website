...
class Topic(models.Model):
    ...
    Topic主表
    """
    category = models.ForeignKey(TopicCategory, verbose_name="留言分类", on_delete=models.CASCADE)
    ...
    # 最后评论人
    last_comment_user = models.CharField(max_length=50, null=True, blank=True, default="", verbose_name="最后评论人名")
    # 最后评论时间
    ...
    markdown_content = models.TextField(max_length=20000, null=True, blank=True, verbose_name="消息内容")
    file = models.FileField(max_length=10000, null=True, blank=True, verbose_name="Topic 附件")
    file_name = models.CharField(max_length=120, null=True, blank=True, verbose_name="Topic 附件路径")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
    update_time = models.DateTimeField(auto_now=True, verbose_name="更新时间")
...
class Comments(models.Model):
    ...
    Comments 评论表
    """
    topic = models.ForeignKey(Topic, verbose_name="留言分类", on_delete=models.CASCADE)
